...
if __name__ == '__main__':
    ...
    if not os.path.exists('/workspace/src/test/' + 'ply'):
        os.makedirs('/workspace/src/test/' + 'ply')
    if not os.path.exists('/workspace/src/test/' + 'z'):
        os.makedirs('/workspace/src/test/' + 'z')
    if not os.path.exists('/workspace/src/test/' + 'ply_Z'):
        os.makedirs('/workspace/src/test/' + 'ply_Z')

    # img, Z -> pc
    for i in [3, 4, 5]:  # range(12):
        # Z_front = cv2.imread('/workspace/src/test/DATA_1024/target/z/{i:05d}_gt_front.png'.format(i=i), cv2.IMREAD_ANYDEPTH).astype(np.float64)
        # Z_back  = cv2.imread('/workspace/src/test/DATA_1024/target/z/{i:05d}_gt_back.png'.format(i=i) , cv2.IMREAD_ANYDEPTH).astype(np.float64)
        # image_front = cv2.imread('/workspace/src/test/DATA_1024/input/color_1024_noshaded/{i:05d}.png'.format(i=i), cv2.IMREAD_ANYCOLOR)
        # image_back  = cv2.imread('/workspace/src/test/DATA_1024/input/color_1024_shaded/{i:05d}_back.png'.format(i=i), cv2.IMREAD_ANYCOLOR)
        ...
        pc.export('/workspace/src/test/ply_Z/{i:05d}_pd_front.ply'.format(i=i))
        pc = Z2pc(image_back, Z_back, 1024, 50)
        pc.export('/workspace/src/test/ply_Z/{i:05d}_pd_back.ply'.format(i=i))
        print(i)

    # pers depth -> Z
    for i in range(12):
        depth_front = cv2.imread('/workspace/src/test/DATA_1024/target/depth_1024_front/{i:05d}.png'.format(i=i),
                                 cv2.IMREAD_ANYDEPTH).astype(np.float64)
        depth_back = cv2.imread('/workspace/src/test/DATA_1024/target/depth_1024_back/{i:05d}.png'.format(i=i),
                                cv2.IMREAD_ANYDEPTH).astype(np.float64)
        ...
        cv2.imwrite('/workspace/src/test/z/{i:05d}_gt_front.png'.format(i=i), d_f)
        d_b = pers_depth2Z(depth_back, 1024, 50)
        cv2.imwrite('/workspace/src/test/z/{i:05d}_gt_back.png'.format(i=i), d_b)

        # img, depth -> mesh
    for i in range(12):
        image_front = cv2.imread('/workspace/src/test/DATA_1024/input/color_1024_noshaded/{i:05d}.png'.format(i=i),
                                 cv2.IMREAD_ANYCOLOR)
        image_back = cv2.imread('/workspace/src/test/DATA_1024/input/color_1024_shaded/{i:05d}_back.png'.format(i=i),
                                cv2.IMREAD_ANYCOLOR)
        depth_front = cv2.imread('/workspace/src/test/DATA_1024/pred/depth_1024_front/{i:05d}.png'.format(i=i),
                                 cv2.IMREAD_ANYDEPTH).astype(np.float64)
        depth_back = cv2.imread('/workspace/src/test/DATA_1024/pred/depth_1024_back/{i:05d}.png'.format(i=i),
                                cv2.IMREAD_ANYDEPTH).astype(np.float64)
        ...
        # pc.export('/workspace/src/test/ply/{i:05d}_pd_front.ply'.format(i=i))
        xyz_b, rgb_b = pers2pc(image_back, depth_back, 1024, 50)
        # pc.export('/workspace/src/test/ply/{i:05d}_pd_back.ply'.format(i=i))
        ...
        print(is_convex)
        tri_mesh.export('/workspace/src/test/ply/{i:05d}_gt_front_mesh.ply'.format(i=i))
    ...
    for i in range(12):
        ...
        pc.export('/workspace/src/test/ply/{i:05d}_gt_front.ply'.format(i=i))
        pc = pers2pc(image_back, depth_back, 1024, 50)
        pc.export('/workspace/src/test/ply/{i:05d}_gt_back.ply'.format(i=i))
