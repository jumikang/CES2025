...
OPENPOSE_JOINTS = [
    ...
    'pelvis',  # 8
    'right_hip', 'right_knee', 'right_ankle',  # 9, 10, 11
    'left_hip', 'left_knee', 'left_ankle',  # 12, 13, 14
    'right_eye', 'left_eye', 'right_ear', 'left_ear',  # 15, 16, 17, 18
    'left_wrist',  # 19
    'left_thumb1', 'left_thumb2', 'left_thumb3', 'left_thumb',  # 20, 21, 22, 23
    'left_index1', 'left_index2', 'left_index3', 'left_index',  # 24, 25, 26, 27
    'left_middle1', 'left_middle2', 'left_middle3', 'left_middle',  # 28, 29, 30, 31
    'left_ring1', 'left_ring2', 'left_ring3', 'left_ring',  # 32, 33, 34, 35
    'left_pinky1', 'left_pinky2', 'left_pinky3', 'left_pinky',  # 36, 37, 38, 39
    'right_wrist',  # 40
    'right_thumb1', 'right_thumb2', 'right_thumb3', 'right_thumb',  # 41, 42, 43, 44
    'right_index1', 'right_index2', 'right_index3', 'right_index',  # 45, 46, 47, 48
    'right_middle1', 'right_middle2', 'right_middle3', 'right_middle',  # 49, 50, 51, 52
    'right_ring1', 'right_ring2', 'right_ring3', 'right_ring',  # 53, 54, 55, 56
    'right_pinky1', 'right_pinky2', 'right_pinky3', 'right_pinky',  # 57, 58, 59, 60
    # Face contour
    'right_contour_1',  # 61
    'right_contour_2',
    'right_contour_3',
...
PIFPAF_JOINTS = [
    ...
    'left_big_toe', 'left_small_toe', 'left_heel', 'right_big_toe', 'right_small_toe', 'right_heel', # 17, 18, 19, 20, 21, 22
    'right_contour_1', 'right_contour_2', 'right_contour_3', 'right_contour_4', 'right_contour_5', 'right_contour_6', 'right_contour_7', 'right_contour_8',# 23, 24, 25, 26, 27, 28, 29, 30, (right face contour)
    'contour_middle', # 31 (center face contour)
    'left_contour_8', 'left_contour_7', 'left_contour_6', 'left_contour_5', 'left_contour_4', 'left_contour_3', 'left_contour_2', 'left_contour_1',# 32, 33, 34, 35, 36, 37, 38, 39 (left face contour)
    'right_eye_brow', 'right_eye_brow2', 'right_eye_brow3', 'right_eye_brow4', 'right_eye_brow5', # 40, 41, 42, 43, 44,
    'left_eye_brow5', 'left_eye_brow4', 'left_eye_brow3', 'left_eye_brow2', 'left_eye_brow', # 45, 46, 47, 48, 49
    'nose1', 'nose2', 'nose3', 'nose4', # 50, 51, 52, 53
    'right_noise_2', 'right_nose_1', 'nose_middle', 'left_nose_1', 'left_nose_2', # 54, 55, 56, 57, 58
    'right_eye1', 'right_eye2', 'right_eye3', 'right_eye4', 'right_eye5', 'right_eye6',  # 59, 60, 61, 62, 63, 64
    'left_eye4', 'left_eye3', 'left_eye2', 'left_eye1', 'left_eye6', 'left_eye5',  # 65, 66, 67, 68, 69, 70
    'right_mouth_1', 'right_mouth_2', 'right_mouth_3', 'mouth_top', 'left_mouth_3', 'left_mouth_2', 'left_mouth_1', # 71, 72, 73, 74, 75, 76, 77
    'left_mouth_5', 'left_mouth_4', 'mouth_bottom', 'right_mouth_4', 'right_mouth_5', # 78, 79, 80, 81, 82
    'right_lip_1', 'right_lip_2', 'lip_top', 'left_lip_2', 'left_lip_1', # 83, 84, 85, 86,  87
    'left_lip_3', 'lip_bottom', 'right_lip_3', # 88, 89, 90
    'left_wrist_end', # 91
    'left_thumb1', 'left_thumb2', 'left_thumb3', 'left_thumb', # 92,93,94,95
    'left_index1', 'left_index2', 'left_index3', 'left_index', # 96,97,98,99
    'left_middle1', 'left_middle2', 'left_middle3', 'left_middle', # 100,101,102,103
    'left_ring1', 'left_ring2', 'left_ring3', 'left_ring', # 104,105,106,107
    'left_pinky1', 'left_pinky2', 'left_pinky3', 'left_pinky', # 108,109,110,111
    'right_wrist_end',  # 112
    'right_thumb1', 'right_thumb2', 'right_thumb3', 'right_thumb', # 113,114,115,116
    'right_index1', 'right_index2', 'right_index3', 'right_index', # 117,118,119,120,
    'right_middle1', 'right_middle2', 'right_middle3', 'right_middle', # 121,122,123,124
    'right_ring1', 'right_ring2', 'right_ring3', 'right_ring', # 125,126,127,128
    'right_pinky1', 'right_pinky2', 'right_pinky3', 'right_pinky', #129,130,131,132
]
...
def body_model_to_dset(model_type='smplx', dset='coco', joints_to_ign=None,
    ...
    elif dset == 'openpifpaf':
        dset_keyp_names = PIFPAF_JOINTS[:23]
    elif dset == 'openpifpaf+wholebody':
        dset_keyp_names = PIFPAF_JOINTS
    elif dset == 'freihand':
...
def dset_to_body_model(model_type='smplx', dset='coco', joints_to_ign=None,
    ...
    model_keyps_idxs = np.array(list(mapping.keys()), dtype=np.int64)
    dset_keyps_idxs = np.array(list(mapping.values()), dtype=np.int64)
