...
def trimesh2o3d(mesh, vertex_color=None, offset=None):
...
def show_meshes(meshes, offset=None):
    # input: a list of trimesh meshes
    vis_mesh = []
    for i, mesh in enumerate(meshes):
        if offset is None:
            vis_mesh.append(trimesh2o3d(mesh))
        else:
            vis_mesh.append(trimesh2o3d(mesh, offset=offset[i]))
